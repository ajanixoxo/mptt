...
const HeroSection = () => {
  ...
  return (
    <section className="pt-20  lg:pt-28 hero  px-4 relative overflow-hidden">
      ...
      <FloatingShape color='from-[#1F22CA] to-transparent' size='w-60 h-60' top='-5%' position="absolute" left='88%' delay={0} />
      {/* Animated stars */}
      <motion.div
        initial={{ opacity: 0 }}
      ...
      {/* Animated stars */}
      <div
        className="absolute top-[30%] -left-40 lg:-left-20 text-purple-400">
      ...
      <div className="container flex flex-col  mx-auto max-w-6xl">
        ...
        <div className="text-center mb-10">
          ...
          <motion.h1
            className="inline-flex main_text flex-col items-center justify-center text-3xl  md:text-5xl main_text lg:text-6xl text-center font-bold mb-2 realtive leading-tight"
          ...
          >
            ...
            >
              with
              <img src="/d-skills.png" className="lg:w-[57%]   w-44  z-10 " />
        ...
        <motion.div className="relative flex w-full justify-center -mt-10 items-end z-10" variants={itemVariants}>
          <motion.img
            src="/4.png"
