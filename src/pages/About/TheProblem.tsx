    ...
    <section className="py-20 px-4 bg-gray-900/30">
      <div className="container mx-auto max-w-6xl">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <img src="https://placehold.co/600x400" alt="Problem illustration" className="rounded-lg shadow-2xl" />
            ...
            <motion.div
              ...
              className="mt-8 inline-block bg-gray-800 rounded-lg p-4 transform -translate-y-1/2 translate-x-1/2"
            >
          ...
          >
            <h2 className="text-4xl md:text-5xl font-bold mb-6 text-white">The Problem</h2>
