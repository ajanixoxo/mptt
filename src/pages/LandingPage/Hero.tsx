...
const HeroSection = () => {
    ...
    return (
        ...
        >
            ...
            <motion.div
                className="absolute top-10 lg:top-20 right-10 w-auto  rounded-sm rotate-12"
            ...
            >
                ...
                <img src={Star} className="w-8 lg:w-[36px]" />
            </motion.div>
            ...
            <div className="container mx-auto max-w-6xl">
                ...
                <div className="flex justify-center flex-col flex-1  items-center">
                    ...
                    <div className="order-1 lg:order-1 flex flex-col items-center relative">
                        <div className="flex justify-between w-full ">
                            ...
                            >
                                ...
                                <img src={Tag} className="w-10 lg:w-auto" />
                            </motion.div>
                        ...
                        >
                            ...
                            <span className="iniline-flex items-center    justify-center text-white px-2 py-1 rounded ">
                                <img src="/rec.png" className="lg:w-[57%] w-48  absolute child lg:top-5 top-3 -right-4 lg:-right-16  z-10 " />
                            ...
                            >
                                ...
                                {isHovered && (
                                    <div className="absolute">   <svg width="438" height="24" viewBox="0 0 438 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <img src={Star} className="absolute top-[60%] -left-20" />
                        <motion.p className="text-[#6A6464] sec_text inline-block mb-8 text-[14px] lg:text-[18px] max-w-lg text-center relative mt-5 z-20" variants={itemVariants}>
                    ...
                    <div className="order-2 lg:order-2 relative">
                        ...
                        {/* Bellow here there is a blur effect at the end of the section blurring the edges bottom of the images and the section do you undestrand so kindily modife all this */}
