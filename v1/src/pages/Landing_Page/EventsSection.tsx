        ...
        <div className="relative">
            ...
            >
                ...
                <div className="container mx-auto max-w-7xl">
                    ...
                    >
                        {events.map((event, index) => (
                            ...
                            >
                                ...
                                <div className="absolute bg-black w-full h-[2px] left-0 ext-[#979292]"></div>
                    ...
                    >
                        <motion.button
                            className="bg-[#2B2B2B]  hover:bg-gray-300 text-white px-6 py-3 rounded-2xl font-medium inline-flex items-center space-x-2"
